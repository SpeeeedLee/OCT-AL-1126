...
METHODS = [
    ...
    ("Aug VF (2x)",    f"{EXP}/aug_curve/vf2/nuclei/cold_start_random/random_*_bs8.json", None),
    ("Aug VF+HV (3x)", f"{EXP}/aug_curve/vfhv3/nuclei/cold_start_random/random_*_bs8.json", None),
