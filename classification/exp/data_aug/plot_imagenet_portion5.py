...
# # 三組實驗數據 (固定1E-4，不然畫不出來==)
# data = {
#     'No Augmentation': [0.5373, 0.5216, 0.5059],
#     '(2x) Horizontal Flip': [0.5451, 0.5412, 0.5569],
#     '(2x) Vertical Flip': [0.549, 0.5529, 0.5608],
#     '(4x) Horizontal, Vertical,\nHorizontal + Vertical Flip': [0.5373, 0.5922, 0.5882, 0.5294, 0.5451]
# }

# 三組實驗數據 (固定5E-5，不然畫不出來==)
data = {
    'No Augmentation': [0.4784, 0.5098, 0.5176],
    '(2x) Horizontal Flip': [0.549, 0.5255, 0.5098],
    '(2x) Vertical Flip': [0.5059, 0.5333, 0.4941],
    '(4x) Horizontal, Vertical,\nHorizontal + Vertical Flip': [0.6, 0.5412, 0.5725, 0.5529, 0.5608]
}
...
ax.set_title(r'Effect of Data Augmentation (5$\%$ labeled training data)', fontsize=26, pad=20)
...
plt.tight_layout()
plt.savefig('./classification/exp/data_aug/fig_imagenet_portion5.png', dpi=300, bbox_inches='tight')
print("圖表已保存至 ./classification/exp/data_aug/fig_imagenet_portion5.png")
plt.close()
