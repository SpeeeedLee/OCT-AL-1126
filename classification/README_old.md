...
python3 ./classification/run_first_iter.py --task_type 'medium' --device 'cuda:0' --portion 100 --batch_size 8  --pretrained_weights 'random' --seed 42
Acc = [0.718447]
...
## ImageNet-pretrained
### Hard
python3 ./classification/run_first_iter.py --task_type 'hard' --device 'cuda:2' --portion 100 --seed 42
Acc = [0.854369]
